...
\lstinputlisting[style=cppcode, firstline = 1, lastline = 28]{chapter_07/quaternion.hpp}

Der konkrete Code ist wie folgt:

\lstinputlisting[style=cppcode, firstline = 1, lastline = 143]{chapter_07/quaternion.cpp}

Wir testen unsere \texttt{Quaternion}-Klasse mit dem folgende Programm:

\lstinputlisting[style=cppcode, firstline = 1, lastline = 40]{chapter_07/exercise_07_38.cpp}
