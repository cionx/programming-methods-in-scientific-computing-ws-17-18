...
\lstinputlisting[style=cppcode, firstline = 1, lastline = 34]{chapter_07/matrix.hpp}

Der konkrete Code der Matrix-Klasse ist wie folgt gegeben:

\lstinputlisting[style=cppcode, firstline = 1, lastline = 139]{chapter_07/matrix.cpp}
