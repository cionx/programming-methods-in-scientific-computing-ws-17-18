...
\lstinputlisting[style=cppcode]{chapter_07/polynomial.hpp}

Der hinterliegende Code ist wie folgt:

\lstinputlisting[style=cppcode]{chapter_07/polynomial.cpp}

Wir testen unsere \texttt{Polynomial}-Klasse mit dem folgenden Code:

\lstinputlisting[style=cppcode]{chapter_07/exercise_07_37.cpp}
