...
\lstinputlisting[style=pythoncode, linerange={1-21}]{chapter_03/exercise_03_05.py}
...
\lstinputlisting[style=pythoncode, linerange={23-26, 32-38, 47-51, 57-62}]{chapter_03/exercise_03_05.py}
