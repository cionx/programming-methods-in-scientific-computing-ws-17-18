...
\lstinputlisting[style=pythoncode, firstline = 6, lastline = 27]{chapter_03/exercise_03_06.py}
...
\lstinputlisting[style=pythoncode, linerange={41-43,50-52,59-60,67-68}]{chapter_03/exercise_03_06.py}
